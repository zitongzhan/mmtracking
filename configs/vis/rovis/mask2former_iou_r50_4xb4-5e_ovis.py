...
# runtime settings
train_cfg = dict(
    type='EpochBasedTrainLoop', max_epochs=total_epochs, val_begin=13)
...
# overwrite the dataset settings
img_size = (960, 480)
train_pipeline = [
    dict(
...
# specify batch size in dataloader
train_dataloader = dict(
    batch_size=4,
    dataset=dict(
        ref_img_sampler=dict(frame_range=5, ),
